      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-3 mb-4">
              ...
              />
              <span className="font-bold text-xl">Tour Der Wang</span>
            </div>
            <p className="text-gray-400 mb-4">
              Food delivery service bringing local cuisine to residents and overseas workers' families.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>Wang Sam Mo, Thailand</li>
              <li>contact@tourderwang.com</li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} Tour Der Wang. All rights reserved.
          </p>
          <div className="flex items-center">
            <Link to="#" className="text-gray-400 hover:text-white text-sm mx-2">Terms</Link>
            <Link to="#" className="text-gray-400 hover:text-white text-sm mx-2">Privacy</Link>
            <Link to="#" className="text-gray-400 hover:text-white text-sm mx-2">Cookies</Link>
          </div>
        </div>
      </div>
    </footer>
